...
public class ViewData extends javax.swing.JDialog {
    ...
    ChecklistController cod = new ChecklistController();

    public ViewData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        paint_table();
        cod.fillTable("SELECT * FROM checklist c JOIN person p ON c.idpessoa = p.id ORDER BY c.id DESC", tabela);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 810, 380));
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        cod.fillTable("SELECT * FROM checklist c JOIN person p ON c.idpessoa = p.id WHERE first_name LIKE '%" + txt_search.getText() + "%' OR last_name LIKE '%" + txt_search.getText() + "%' OR office LIKE '%" + txt_search.getText() + "%' ORDER BY c.id DESC", tabela);
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        try {
            ...
            conecta.executaSQL("SELECT * FROM checklist c JOIN person p ON c.idpessoa = p.id WHERE p.id = '" + nome + "'");
            conecta.rs.first();
            id = conecta.rs.getInt("p.id");
    ...
    private void botaoexcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoexcluirActionPerformed
        //cod.delete(id);
        cod.fillTable("SELECT * FROM checklist ORDER BY id DESC", tabela);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewData dialog = new ViewData(new javax.swing.JFrame(), true);
